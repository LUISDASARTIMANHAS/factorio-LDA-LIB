...
--- @return MapPosition
function Module.getRandomPositionAround(centerX, centerY,SPAWN_RADIUS_MIN,SPAWN_RADIUS_MAX)
    local angle = math.random() * math.pi * 2
    local distance = math.random(SPAWN_RADIUS_MIN or 96, SPAWN_RADIUS_MAX or 256)
